...
xbind = function () {
	...
	// default value change association function
	var defaultChangeFunctionConnector = function (element, handler) { element.onchange = handler; };

	// The Bind function
	function bind(jsObj, jsProp, htmlElement, validationFunc, getFunc, setFunc, changeFunc) {
		var bindingInfo = {};
		...
		bindingInfo.changeConnector = changeFunc || defaultChangeFunctionConnector;
		...
		// TODO: Need an assign function or something!?!?!
		changeFunc(htmlElement, bindingInfo.domBinding); // htmlElement.onchange = bindingInfo.domBinding;
